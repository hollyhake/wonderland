...
# Load data
load("C:/Users/17203/Documents/GitHub/Blaarkop/data/SlimStampen_2022-09-04.RData")
...
clinical$level_order<- factor(clinical$lessonTitle, level = c('Pasta','Swahili 1','Flowers','European Capitals 1','Birds', 'Newspapers','Asian Flags', 'Folktales', 'Maps', 'US Towns 1', 'Art', 'Hindu Gods'))

xlabels <- c("Pasta", "Swahili", "Flowers", "Capitals", "Birds","News", "Flags", "Folktales", "Maps", "Towns", "Art", "Hindi")
...
lessons_cols <- c("Pasta", "Swahili_1", "Flowers", "European_Capitals_1", "Birds","Newspapers", "Asian_Flags", "Folktales", "Maps", "US_Towns_1", "Art", "Hindu_Gods")
...
correlations$Lesson<- factor(correlations$Lesson, level = c('Pasta','Swahili 1','Flowers','European Capitals 1','Birds', 'Newspapers','Asian Flags', 'Folktales','Maps', 'US Towns 1', 'Art','Hindu Gods'))
correlations$With<- factor(correlations$With, level = c('Pasta','Swahili 1','Flowers','European Capitals 1','Birds', 'Newspapers','Asian Flags', 'Folktales','Maps', 'US Towns 1', 'Art','Hindu Gods'))
