...
# Load data
load("C:/Users/17203/Documents/GitHub/Blaarkop/data/SlimStampen_2022-08-04.RData")
...
clinical$level_order<- factor(clinical$lessonTitle, level = c('Pasta','Swahili 1','Flowers','European Capitals 1','Birds', 'Newspapers','Asian Flags', 'Folktales'))

xlabels <- c("Pasta", "Swahili", "Flowers", "Capitals", "Birds","News", "Flags", "Folktales")
